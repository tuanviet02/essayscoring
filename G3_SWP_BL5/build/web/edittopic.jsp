    ...
    <body class="g-sidenav-show bg-gray-200">
        <aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-3 bg-gradient-dark"id="sidenav-main" >
            <div class="sidenav-header">
                ...
                <a class="navbar-brand m-0" target="_blank">
                    ...
                    <span class="ms-1 font-weight-bold text-white">Edit Topic</span>
                </a>
            </div>
                    ...
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb bg-transparent mb-0 pb-0 pt-1 px-0 me-sm-6 me-5">
                            ...
                            <li class="breadcrumb-item text-sm text-dark active" aria-current="page">
                                <a class="opacity-5 font-weight-bolder">Edit Topic</a>
                            </li>
                        </ol>
                    </nav>
                ...
                <div class="row d-flex justify-content-center align-items-center">
                    <div class="col-md-11 ">
                        <div class="card ">
                            ...
                            <div class="card-body">
                                <form action="edittopic" method="post" onsubmit="return validate()">
                                    <input type="hidden" name="id" value="${requestScope.topic.topicId}" /> <br/>
                                    <div class="row form-group">
                                        <label class="col-form-label col-md-2">Title</label>
                                        <div class="col-md-12 " >
                                            <input name="title" type="text" class="form-control border" value="${requestScope.topic.title}" required/>
                                        </div>
                                    </div><br>
                                    ...
                                    <div class="row form-group">
                                        ...
                                        <div class="col-md-12">
                                            <select class="form-select" name="level" value="${requestScope.topic.level.levelId}">
                                    ...
                                    <div class="row form-group">
                                        ...
                                        <div class="col-md-12">
                                            <select class="form-select" name="type" value="${requestScope.topic.type.typeId}">
                                    ...
                                    <div class="row form-group">
                                        ...
                                        <div class="col-md-12">
                                            <textarea name="description" rows="5" cols="5" class="form-control border" placeholder="  Enter text here" required>${requestScope.topic.description}</textarea>
                                        </div>
                                    </div><br>
                                    <div class="form-group mb-0 row">                   
                                        <div class="col-md-5">
                                            <a href="topiclist"><button class="btn btn-danger" type="button">
                                                    Cancel
                                                </button></a>  
        ...
        <script type="text/javascript">
                                    function validate() {
                                        ...
                                        // at least 1 box is checked then submit
                                        return true;
                                    }
        </script>
    </body>
