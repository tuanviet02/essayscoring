        ...
        <aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-3 bg-gradient-dark"id="sidenav-main" >
            <div class="sidenav-header">
                ...
                <a class="navbar-brand m-0" target="_blank">
                    ...
                    <span class="ms-1 font-weight-bold text-white">Add Topic</span>
                </a>
            </div>
                    ...
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb bg-transparent mb-0 pb-0 pt-1 px-0 me-sm-6 me-5">
                            ...
                            <li class="breadcrumb-item text-sm text-dark active" aria-current="page">
                                <a class="opacity-5 font-weight-bolder" >Add Topic </a>
                            </li>
                        </ol>
                    </nav>
                            ...
                            <div class="card-body">
                                <form action="addtopic" method="post" onsubmit="return validate()">
                                    <div class="row form-group">
                                        ...
                                        <div class="col-md-12 " >
                                            <input name="title" type="text" class="form-control border" required/>
                                        </div>
                                    </div><br>
                                    ...
                                    <div class="row form-group">
                                        ...
                                        <div class="col-md-12">
                                            <div class="checkbox">
                                                <c:forEach items="${requestScope.listCriteria}" var="c">
                                                    <input type="checkbox" name="criteria" value="${c.criteriaID}"/> ${c.criteriaName}<br>
                                                </c:forEach>
                                            </div>
                                    ...
                                    <div class="row form-group">
                                        ...
                                        <div class="col-md-12">
                                            <textarea name="description" rows="5" cols="5" class="form-control border" placeholder="  Enter text here" required></textarea>
                                        </div>
                                    </div><br>
