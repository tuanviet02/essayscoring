    ...
    <body>
      ...
      <div class="sidenav-header">
        ...
        <a class="navbar-brand m-0" href="./" target="_blank">
          ...
          <span class="ms-1 font-weight-bold text-white">Edit Feedback Criteria</span>
        </a>
      </div>
                    ...
                    <div class="tab-content">
                        <c:forEach var="criteriaFeedback" items="${criteriaFeedbackList}">
                            <section id="criteria${criteriaFeedback.criteriaFeedbackID}"  data-default>
                                ...
                                <form action="editCriteriaFeedback" method="post">
                                    <input type="hidden" name="criteria_feedback_id" value="${criteriaFeedback.criteriaFeedbackID}">  
                                  <input type="hidden" name="evaluator_essay_id" value="${param.evaluator_essay_id}">  
                                    <input class="textarea" type="text" name ="feedback_content" value="${criteriaFeedback.feedbackContent}"> 
...
<!-- <td>${criteriaFeedback.criteriaFeedbackID}</td>
                    <td>${criteriaFeedback.criteria.criteriaName}</td>
                    <td>${criteriaFeedback.criteria.description}</td>
                    <td>${criteriaFeedback.feedbackContent}</td>-->