              ...
              <div class="card-body">
                <form action="approvetopic" method="post">
                  ...
                  <div class="form-group mb-0 row">                   
                    <div class="col-md-5">
                        <button class="btn btn-danger" name="action" type="submit" value="Rejected">Reject</button> 
                        <button class="btn btn-success" name="action" type="submit" value="Approved">Approve</button>
                        <a href="approvaltopiclist"><button class="btn btn-secondary" type="button">Cancel</button></a>               
                    </div>
                  </div>
                </form>
              </div>
