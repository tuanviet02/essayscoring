        ...
        <aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-3 bg-gradient-dark"id="sidenav-main" >
            <div class="sidenav-header">
                ...
                <a class="navbar-brand m-0" target="_blank">
                    ...
                    <span class="ms-1 font-weight-bold text-white">Add Type</span>
                </a>
            </div>
                    ...
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb bg-transparent mb-0 pb-0 pt-1 px-0 me-sm-6 me-5">
                            ...
                            <li class="breadcrumb-item text-sm text-dark active" aria-current="page">
                                <a class="opacity-5 font-weight-bolder">Add Type</a>
                            </li>
                        </ol>
                    </nav>
                    ...
                    <div class="col-md-10 ">
                        <div class="card ">
                            <div class="card-header">
                                <h5 class="card-title">Create New Essay Type</h5>
                            </div>
                            <c:if test="${requestScope.error!=null}">
                                <h6 style="color: red">&nbsp;&nbsp;${requestScope.error}</h6>
                            </c:if>
                            <div class="card-body">
                                <form action="addessaytype" method="post" >
                                    <div class="row form-group">
                                        <label class="col-form-label col-md-2">Essay Type Name</label>
                                        <div class="col-md-12 " >
                                            <input name="name" type="text" class="form-control border" required/>
                                        </div>
                                    </div><br>
