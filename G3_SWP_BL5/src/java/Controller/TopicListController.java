...
public class TopicListController extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try ( PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet EssayListController</title>");
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet EssayListController at " + request.getContextPath() + "</h1>");
            out.println("</body>");
            out.println("</html>");
        }
    }
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        if (userSession == null || userSession.getRole().getRole_id() != 3) {
            ...
            int total = topicDAO.getTotalTopic(userId);
            int page = total / 5;
            if (total % 5 != 0) {
                page += 1;
            }
            ...
            List<Topic> listTopic = topicDAO.listTopicPaging(index, userId);
