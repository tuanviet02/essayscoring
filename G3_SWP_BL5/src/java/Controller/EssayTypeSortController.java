 ...
 * @author admin
 */
public class EssayTypeSortController extends HttpServlet {
    ...
    throws ServletException, IOException {
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet EssayTypeSortController</title>");  
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet EssayTypeSortController at " + request.getContextPath () + "</h1>");
            out.println("</body>");
            out.println("</html>");
        }
    } 
    ...
    throws ServletException, IOException {
        ...
        int total = essayTypeDAO.getTotalType();       
        int page = total/5;
        if(total%5!=0){
            page+=1;
        }
        int index = Integer.parseInt(raw_index);
        List<EssayType> listEssayType = essayTypeDAO.sortEssayType(sort,index);
