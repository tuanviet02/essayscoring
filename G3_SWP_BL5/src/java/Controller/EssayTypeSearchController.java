 ...
 * @author admin
 */
public class EssayTypeSearchController extends HttpServlet {
    ...
    throws ServletException, IOException {
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet EssayTypeSearchController</title>");  
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet EssayTypeSearchController at " + request.getContextPath () + "</h1>");
            out.println("</body>");
            out.println("</html>");
        }
    } 
    ...
    throws ServletException, IOException {
        ...
        //paging
        int total = essayTypeDAO.getTotalTypeBySearch(search);       
        int page = total/5;
        if(total%5!=0){
            page+=1;
        }
        int index = Integer.parseInt(raw_index);
        List<EssayType> listEssayType = essayTypeDAO.searchEssayType(search,index);
