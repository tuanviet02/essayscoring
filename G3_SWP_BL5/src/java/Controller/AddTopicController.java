...
public class AddTopicController extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try ( PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet AddEssayController</title>");
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet AddEssayController at " + request.getContextPath() + "</h1>");
            out.println("</body>");
            out.println("</html>");
        }
    }
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        if (userSession == null || userSession.getRole().getRole_id() != 3) {
            ...
            boolean checkTopicExist = false;        //check topic title
            ...
            if (checkTopicExist) {
                ...
                request.setAttribute("listEssayType", listEssayType);
                request.setAttribute("listCriteria", listCriteria);
                request.setAttribute("error", "Topic is exist");
                request.getRequestDispatcher("addtopic.jsp").forward(request, response);
            }
            if (checkTopicExist == false) {
