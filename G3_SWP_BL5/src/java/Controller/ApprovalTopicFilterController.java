 ...
 * @author admin
 */
public class ApprovalTopicFilterController extends HttpServlet {
    ...
    throws ServletException, IOException {
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet ApprovalTopicFilterController</title>");  
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet ApprovalTopicFilterController at " + request.getContextPath () + "</h1>");
            out.println("</body>");
            out.println("</html>");
        }
    } 
    ...
    throws ServletException, IOException {
        ...
        List<Topic> topics = topicDAO.filter(level,type,status);
        ...
        request.setAttribute("topics", topics.subList(start,end));        //return a list of start index to end index
