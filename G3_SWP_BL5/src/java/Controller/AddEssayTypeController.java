 ...
 * @author admin
 */
public class AddEssayTypeController extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try ( PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet AddEssayTypeController</title>");
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet AddEssayTypeController at " + request.getContextPath() + "</h1>");
            out.println("</body>");
            out.println("</html>");
        }
    }
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        if (userSession == null || userSession.getRole().getRole_id() != 3) {
            ...
            request.getRequestDispatcher("addessaytype.jsp").forward(request, response);
        }
    }
        ...
        if (userSession == null || userSession.getRole().getRole_id() != 3) {
            ...
            if (name == null || name.equals("")) {
                ...
                if (checkTypeExist == false) {
                    ...
                    essayTypeDAO.createNewType(essayType);
